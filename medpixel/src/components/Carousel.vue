<template>
  <div class="carousel-container">
    ...
    <div class="carousel" ref="carousel" :style="carouselStyle">
...
.carousel {
  /* Modification : retire display: flex; */
  white-space: nowrap;
  padding: 1rem;
}

.slide {
  /* Modification : retire flex: 0 0 auto; */
  display: inline-block;
  width: 100%; /* Assure-toi que chaque slide a la largeur du conteneur du carrousel */
  /* margin-right: 16px; Espacement entre les slides si nécessaire */
  margin: 0 1rem;
}
